...
//        int temp2 = longestCommonSubstring(newStrA, newStrB).length();
    ...
    public static void main(String[] args) {
        String str1 = "abcdabcdabcdabcdabcdabcdabcdabcdabcd";
        String str2 = "vbcdabcdabcdabcdabcdabcdabcdabcdabcd";
        double Similarity = SimilarDegree(str1, str2);
        System.out.println(String.format("%.4f", Similarity));
    }
}
